      ...
      *
       RANGER-CLE-GLOBALE.
           ...
           PERFORM VERIFIER-LIGNE-ENTIERE
      ...
      *
      *    UN ENREGISTREMENT FAIT 40 + 700 OCTETS. QUAND UNE LIGNE DU
      *    FICHIER EST PLUS LONGUE, LA LECTURE SEQUENTIELLE NE SIGNALE
      *    RIEN : ELLE REMPLIT L ENREGISTREMENT ET SERT LE RESTE AU
      *    TOUR SUIVANT, QUI DEVIENT ALORS UNE CLE FANTOME FAITE DE LA
      *    QUEUE DE LA LIGNE PRECEDENTE. LE SITE SE CONSTRUISAIT SANS
      *    BRONCHER AVEC UNE ENTREE INVENTEE DEDANS.
      *    LE DERNIER OCTET DE LA ZONE VALEUR TRAHIT LE DEBORDEMENT :
      *    S IL N EST PAS BLANC, C EST QUE LA LIGNE ETAIT PLEINE A RAS
      *    BORD, DONC PROBABLEMENT TRONQUEE.
       VERIFIER-LIGNE-ENTIERE.
           IF WS-VALEUR-COURANTE(700:1) NOT = SPACE
               DISPLAY " "
               DISPLAY "BUILDSITE : LIGNE TROP LONGUE DANS "
                       FUNCTION TRIM(WS-SECTION-COUR)
               DISPLAY "  CLE : " FUNCTION TRIM(WS-CLE-COURANTE)
               DISPLAY "  UNE VALEUR TIENT EN 700 CARACTERES AU PLUS. "
                       "RACCOURCIR, SINON LA QUEUE DE LA LIGNE "
                       "DEVIENDRAIT UNE CLE FANTOME."
      ...
      ******************************************************************
       GENERER-PAGE.
           ...
           CLOSE F-PAGE
           CLOSE F-SORTIE
           PERFORM VERIFIER-PAGE-NON-VIDE.
      *
      *    UN GABARIT VIDE OU ILLISIBLE PRODUISAIT UNE PAGE DE ZERO
      *    OCTET, ET LE PROGRAMME RENDAIT SUCCES. LE SITE SE SERAIT
      *    PUBLIE VIDE SANS QU AUCUNE ETAPE NE PROTESTE.
       VERIFIER-PAGE-NON-VIDE.
           IF WS-NO-LIGNE = ZERO
               DISPLAY " "
               DISPLAY "BUILDSITE : templates/page.tpl NE CONTIENT "
                       "AUCUNE LIGNE. RIEN A GENERER."
